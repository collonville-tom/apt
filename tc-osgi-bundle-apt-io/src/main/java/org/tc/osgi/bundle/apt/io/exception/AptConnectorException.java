 ...
 * @version 0.0.1
 */
public class AptConnectorException extends AptException {
	 ...
	 */
	public AptConnectorException(final String _message) {
		super(_message);
	}
	 ...
	 * @param _e Throwable
	 */
	public AptConnectorException(final String _message, final Throwable _e) {
		super(_message, _e);
	}
}
